...
,
      {
        ...
        const matchedCollection = staticCollections.find(c => c.slug === slug);
        if (matchedCollection) {
          setCollection(matchedCollection);
          const matchedProducts = staticProducts.filter(p => p.collection === matchedCollection._id);
          dispatch(setProducts(matchedProducts));
        } else {
          setCollection(null);
        }
      } catch (err) {
